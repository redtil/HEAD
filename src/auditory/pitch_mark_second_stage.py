...
def optimal_accumulated_log_probability(sndarray, all_snd_info):
    ...
    for pitch_marks_all in all_snd_info["pitch_marks"]:
        best_pitch_marks_voiced_regions = []
        cntVoicedRegions = 0
        for pitch_marks_voiced_region in pitch_marks_all:
            ...
            for pitch_marks_freq_chunk in pitch_marks_voiced_region:
                best_pitch_marks_freq_chunks.append(optimal_accumulated_log_probability_recur(sndarray,pitch_marks_freq_chunk,hmax,hmin,44100))
            best_pitch_marks_voiced_regions.append(best_pitch_marks_freq_chunks)
        best_voiced_region_freq_chunk_windows_pitch_marks_obj["best_pitch_marks"].append(best_pitch_marks_voiced_regions)
        cnt = cnt + 1
...
if __name__ == "__main__":
    ...
    optimal_accumulated_log_probability(voiced_region_freq_chunk_windows_pitch_marks_obj)